...
public class testDaysCalculator {
	...
	public void testMainSameYearMonth() {
		...
		assertEquals(cal.dayswithinMonths(date1, date2) - 1, 19);

		//test leap year
		MyDate date3 = new MyDate("01/02/2012");
		MyDate date4 = new MyDate("29/02/2012");
		assertEquals(cal.dayswithinMonths(date3, date4) - 1, 27);
	...
	public void testMainSameYear() {
		...
		assertEquals(cal.dayswithinMonths(date1, date2) + cal.daysinMonths(date1, date2) - 1, 173);

		//test leap year
		MyDate date3 = new MyDate("01/02/2012");
		MyDate date4 = new MyDate("05/03/2012");
		assertEquals(cal.dayswithinMonths(date3, date4) + + cal.daysinMonths(date3, date4) - 1, 32);
	}
	...
	public void testMainDifferentYear() {
		...
		assertEquals(cal.dayswithinMonths(date1, date2) + cal.daysinMonths(date1, date2) + cal.daysinYears(date1.getYear(), date2.getYear()) - 1, 1979);

		//test same month and day
		MyDate date3 = new MyDate("04/07/1982");
		MyDate date4 = new MyDate("04/07/1983");

		assertEquals(cal.dayswithinMonths(date3, date4) + cal.daysinMonths(date3, date4) + cal.daysinYears(date3.getYear(), date4.getYear()) - 1, 364);
		...
		assertEquals(cal.dayswithinMonths(date5, date6) + cal.daysinMonths(date5, date6) + cal.daysinYears(date5.getYear(), date6.getYear()) - 1, 365);
